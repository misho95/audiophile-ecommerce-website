...
const LastItems = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-10 sm:gap-5">
      <div className="w-full md:w-px350 lg:w-w540 h-80 rounded-lg overflow-hidden">
        <img src={earPhones} className="h-full object-cover" />
      </div>
      <div className="w-full md:w-px350 lg:w-w540 h-80 bg-customGray relative rounded-lg overflow-hidden">
